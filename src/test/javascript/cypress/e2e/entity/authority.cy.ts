...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '55fdcf08-8c08-47d5-aaa8-e9a3111f83c0' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('8f3d2700-c829-4f62-a5c5-2ad1ff354290');
      cy.get(`[data-cy="name"]`).should('have.value', '8f3d2700-c829-4f62-a5c5-2ad1ff354290');
